...
public enum ProcessingFlag implements BooleanFlag
{
	...
	STOP_LIST_TEMPLATE_STATIC('T', "static", "Apply a stop word list based on the most recent ISSUE_TEMPLATE"),
	STOP_LIST_TEMPLATE_DYNAMIC('D', "dynamic", "Apply a dynamic stop word list based on the ISSUE_TEMPLATE when the issue was created"),
